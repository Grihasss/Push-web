<template>
  <div>
    ...
    <button id="subscribe" @click="subscribeButtonHandler">
      Subscribe to push
    </button>
    <button id="unsubscribe" @click="unsubscribeButtonHandler">
      Unsubscribe from push
    </button>
    <button id="notify-me" @click="notifyMe">Notify me</button>
    <button id="notify-all" @click="notifyEveryone">Notify all</button>
  </div>
</template>
